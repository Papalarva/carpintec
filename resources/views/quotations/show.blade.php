    ...
    <div class="max-w-2xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white rounded-lg shadow p-6 space-y-4">
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 gap-2">
                        @foreach($quotation->attachments as $attachment)
                            ...
                            @endphp
                            <a href="{{ $url }}" target="_blank" class="flex items-center p-2 border rounded hover:bg-gray-50">
            ...
            <div class="pt-4 border-t">
                <a href="{{ route('quotations.index') }}" class="text-indigo-600 hover:text-indigo-900">← Volver a mis cotizaciones</a>
            </div>
        </div>
    </div>
</x-app-layout>