    ...
    <x-admin.table :headers="[
        ...
        @forelse($orders as $order)
            <tr class="hover:bg-gray-50/50 transition-colors">
                <td class="px-6 py-4 whitespace-nowrap text-sm font-bold text-amber-900 font-sans tracking-wide">
                    #{{ substr($order->id, 0, 8) }}
                </td>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm flex items-center font-sans">
                    <a href="{{ route('admin.orders.show', $order) }}" class="p-2 text-gray-400 hover:text-amber-900 hover:bg-amber-50 rounded-xl transition-colors" title="Ver Detalle">
        ...
        @empty
            <tr>
                <td colspan="6" class="px-6 py-16 text-center bg-white">
                    ...
                    <span class="text-base font-medium text-gray-400 font-sans">No se encontraron pedidos registrados.</span>
                </td>
            </tr>
        @endforelse
    </x-admin.table>
