...
@section('content')
    <form action="{{ route('admin.collections.update', $collection) }}" method="POST" class="max-w-5xl mx-auto">
        @csrf
        @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-12 gap-x-8 gap-y-7">
                ...
                <div class="md:col-span-12">
                    ...
                    <textarea name="description" id="description" rows="3"
                        class="block w-full rounded-xl border-gray-200 bg-gray-50/50 py-3.5 text-sm focus:bg-white focus:ring-amber-900 focus:border-amber-900 transition-colors shadow-sm font-sans resize-none">{{ old('description', $collection->description) }}</textarea>
