        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8">
            ...
            <div class="mt-6 font-sans">
                ...
                <textarea name="description" id="description" rows="3"
                    class="block w-full rounded-xl border-gray-200 bg-gray-50 py-3.5 text-sm focus:ring-amber-800 focus:border-amber-800 transition-colors shadow-sm">{{ old('description') }}</textarea>
            </div>
        </div>
