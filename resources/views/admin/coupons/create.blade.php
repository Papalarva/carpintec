...
<div class="max-w-3xl mx-auto">
    <form action="{{ route('admin.coupons.store') }}" method="POST">
        ...
        <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8 mb-8" x-data="{ 
            ...
            <h3 class="text-xl font-serif font-bold text-gray-900 mb-6 border-b border-gray-100 pb-4">Configuración del Cupón</h3>
            ...
            <div class="grid grid-cols-1 gap-8 font-sans">
                    ...
                    <div class="flex flex-col sm:flex-row gap-3">
                        <div class="relative flex-1">
                            ...
                            <input type="text" name="code" x-model="code"
                                   ...
                                   class="block w-full pl-12 rounded-xl border-dashed border-2 border-amber-200 bg-amber-50 py-4 text-lg font-bold font-mono uppercase text-amber-900 focus:ring-amber-800 focus:border-amber-800 transition-colors placeholder-amber-900/30">
                        </div>
                        <button type="button" @click="generateCode()" class="px-6 py-4 bg-white border border-gray-200 text-gray-700 hover:bg-gray-50 uppercase tracking-widest text-xs font-bold rounded-xl shadow-sm transition-colors whitespace-nowrap">
                            Aleatorio
                        </button>
                    </div>
                    <p class="text-xs text-gray-500 mt-3 font-sans leading-relaxed">Si lo dejas vacío, el sistema generará uno automáticamente. Los clientes ingresarán este código exacto en el checkout.</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-gray-100 pt-8 mt-2">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-500 mt-2 font-sans">Dejar vacío para usos ilimitados.</p>
                    ...
                    <div>
                        ...
                        <input type="datetime-local" name="expires_at" value="{{ old('expires_at') }}"
                               class="block w-full rounded-xl border-gray-200 bg-gray-50 py-3.5 text-sm focus:ring-amber-800 focus:border-amber-800 transition-colors shadow-sm">
                        <p class="text-xs text-gray-500 mt-2 font-sans">Fecha y hora en que dejará de ser válido.</p>
