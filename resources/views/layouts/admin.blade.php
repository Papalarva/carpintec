        ...
        <aside class="w-64 bg-gray-800 text-white flex-shrink-0">
            ...
            <nav class="mt-4">
                ...
                @role('admin')
                    ...
                    <x-admin.sidebar-link href="{{ route('admin.discounts.index') }}"
                        :active="request()->routeIs('admin.discounts.*')">Descuentos</x-admin.sidebar-link>
                    <x-admin.sidebar-link href="{{ route('admin.inventory.index') }}" :active="request()->routeIs('admin.inventory.*')">
                        Inventario
                    </x-admin.sidebar-link> 
                    <x-admin.sidebar-link href="{{ route('admin.coupons.index') }}"
                        :active="request()->routeIs('admin.coupons.*')">Cupones</x-admin.sidebar-link>
                    <x-admin.sidebar-link href="{{ route('admin.reports.index') }}"
                        :active="request()->routeIs('admin.reports.*')">Reportes</x-admin.sidebar-link>
                @endrole
            </nav>
        </aside>
